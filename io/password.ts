/**
 * Stolen from https://github.com/justjavac/deno_getpass/blob/v0.1.1/mod.ts because that one has a broken dep
 *
 * Requires `--unstable` flag
 */

// import { encode, decode } from "https://deno.land/std/encoding/utf8.ts";
// Instead of importing that^ broken dep, just reimplement it here:
...
// Here begins the stuff copied from https://github.com/justjavac/deno_getpass
